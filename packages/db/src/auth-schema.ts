...
export const user = sqliteTable("user", (t) => ({
  ...
  image: t.text(),
  discordBannerUrl: t.text(),
  discordAccentColor: t.integer(),
  discordAvatarDecorationUrl: t.text(),
  discordGuildTag: t.text(),
  discordGuildBadgeUrl: t.text(),
  discordNameplateUrl: t.text(),
  discordPublicFlags: t.integer(),
  discordProfileSyncedAt: t.integer({ mode: "timestamp" }),
  discordProfileRevision: t.text(),
